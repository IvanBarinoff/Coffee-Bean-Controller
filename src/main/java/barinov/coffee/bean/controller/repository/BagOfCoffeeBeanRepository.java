...
@Repository
public interface BagOfCoffeeBeanRepository extends JpaRepository<BagOfCoffeeBean, Integer>,
        JpaSpecificationExecutor<BagOfCoffeeBean>, BagOfCoffeeBeanCustomRepository {
